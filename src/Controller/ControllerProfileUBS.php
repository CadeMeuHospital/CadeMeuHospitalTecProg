...
class ControllerProfileUBS
{
    ...
    public function getDistanceBetweenTwoLatLon($fromLatitude, $fromLongitude, $toLatitude, $to_lon)
    {
        return DistanceLatLon::computeDistance($fromLatitude, $fromLongitude, $toLatitude, $to_lon);
    }
